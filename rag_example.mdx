...
<Steps>
  <Step title="Set up your API keys">
    ...
    <Note>
    Don't have a ScaleDown API key yet? [Create an account](https://scaledown.ai/) or [Contact our sales team](https://app.reclaim.ai/m/neal-scaledown/25-min) to get one.
    </Note>
  </Step>
