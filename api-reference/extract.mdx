...
<ResponseField name="entities" type="array">
  ...
  <Expandable title="Entity object">
    ...
    <ResponseField name="context" type="string">
      Surrounding text around the entity span. The window size is controlled by the `context_chars` request parameter (default: 500 characters per side). Prefixed/suffixed with `...` when clipped.
    </ResponseField>
  </Expandable>
</ResponseField>
