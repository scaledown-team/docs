...
description: "Copy-paste AI prompts to generate integration code for the /decisions endpoint."
---

Copy one of these prompts into Claude, ChatGPT, or any AI assistant to generate integration code for the `/decisions` endpoint. Start with the **quick integration** prompt to get something working fast, or use the **production-ready** prompt if you're building for a live environment.
...
API details:
- Endpoint: POST https://api.scaledown.xyz/decisions
...
If you have existing code calling `POST https://openrouter.ai/api/alpha/decisions`, porting to `/decisions` is mostly a base-URL and auth-header swap:

| | Jev | ScaleDown `/decisions` |
|---|---|---|
| URL | `https://openrouter.ai/api/alpha/decisions` | `https://api.scaledown.xyz/decisions` |
